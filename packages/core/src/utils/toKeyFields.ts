...
export function toKeyFields<Fields extends Record<string, any> = object, KeyFields extends CustomTreeKeyFields = DefaultTreeKeyFields>(record: Record<string, any>, fieldNames: Required<NonUndefined<FlexTreeManagerOptions['fields']>>): IFlexTreeNode<Fields, KeyFields> {
