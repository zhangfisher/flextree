...
export function fromKeyFields<Fields extends Record<string, any> = object, KeyFields extends CustomTreeKeyFields = DefaultTreeKeyFields>(
    node: IFlexTreeNode<Fields, KeyFields>,
