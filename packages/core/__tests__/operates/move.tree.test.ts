...
describe("移动树节点", () => {
  ...
  describe("NextSibling - 移动节点到目标节点的后面成为其下一个兄弟节点", () => {
    // 向下移动:  目标节点在源节点的下面
    test("向下移动：同级内节点移动到下一个兄弟节点", async () => {
    ...
    test("向下移动：同级内节点连续移动到多个下一个兄弟节点", async () => {
      let a1 = (await tree.findNode({ name: "A-1-1" }))!;
      let a2 = (await tree.findNode({ name: "A-1-2" }))!;
    ...
    test("向下移动：根节点级别的子树连续移动到多个下一个兄弟节点", async () => {
    ...
    // 向上移动：目标节点在源节点的上面
    test("向上移动：同级内节点移动到下一个兄弟节点", async () => {
      let a2 = (await tree.findNode({ name: "A-1-2" }))!;
      let a5 = (await tree.findNode({ name: "A-1-5" }))!;
      await tree.write(async () => {
    ...
    test("向上移动：同级内节点连续移动到多个下一个兄弟节点", async () => {
  ...
  describe("PreviousSibling - 移动节点到目标节点的前面成为其上一个兄弟节点", () => {
    // 目标节点在源节点的前面
    test("向上移动：同级内节点移动到上一个兄弟节点", async () => {
      let a1 = (await tree.findNode({ name: "A-1-1" }))!;
      let a2 = (await tree.findNode({ name: "A-1-2" }))!;
      await tree.write(async () => {
    ...
    test("向上移动：同级内节点连续移动到多个上一个兄弟节点", async () => {
      let a1 = (await tree.findNode({ name: "A-1-1" }))!;
      let a2 = (await tree.findNode({ name: "A-1-2" }))!;
      let a3 = (await tree.findNode({ name: "A-1-3" }))!;
      let a4 = (await tree.findNode({ name: "A-1-4" }))!;
    ...
    // 目标节点在源节点的后面
    test("向下移动：同级内节点移动到上一个兄弟节点", async () => {
      let a1 = (await tree.findNode({ name: "A-1-1" }))!;
      let a3 = (await tree.findNode({ name: "A-1-3" }))!;
      await tree.write(async () => {
    ...
    test("向下移动：同级内节点连续移动到多个上一个兄弟节点", async () => {
      let a1 = (await tree.findNode({ name: "A-1-1" }))!;
      let a2 = (await tree.findNode({ name: "A-1-2" }))!;
      let a3 = (await tree.findNode({ name: "A-1-3" }))!;
      let a4 = (await tree.findNode({ name: "A-1-4" }))!;
